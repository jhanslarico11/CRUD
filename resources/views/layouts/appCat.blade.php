...
<body>
    <h1 class="text-center mt-5 mb-5 fw-bold">CRUD
    </h1>
    ...
    <div class="container">
        ...
        <div class="row justify-content-md-center">
            <div class="col-md-4" style="border-right: 1px solid #dee2e6;">
                <h1 class="text-center">Registrar categoria <hr></h1>
                @include('categorias.add')
            </div>
            ...
            <div class="col-md-8">
                ...
                <h1 class="text-center">Lista de categoria <hr></h1>
